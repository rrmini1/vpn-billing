...
const messages = {
    ru: {
        ...
        dashboard: {
            ...
            addEmailText: 'Укажите email. Если аккаунт уже есть, мы отправим письмо для объединения. Если нет, подтвердим email и создадим пароль.',
        ...
        attachEmail: {
            ...
            text: 'Email подтвержден. Создайте пароль, чтобы завершить настройку аккаунта.',
            savePassword: 'Сохранить пароль',
            completed: 'Email добавлен. Теперь можно входить по email и паролю.',
            missingToken: 'В ссылке нет токена подтверждения email.',
        },
        subscription: {
            title: 'Подписка',
        ...
        admin: {
            ...
            saved: 'Сохранено',
            newPlan: 'Новый тариф',
            createPlan: 'Добавить тариф',
            planCreated: 'Тариф добавлен',
            limitSaved: 'Лимит обновлен',
            totalUsers: 'Клиенты',
    ...
    en: {
        ...
        dashboard: {
            ...
            addEmailText: 'Enter an email. If the account already exists, we will send a merge confirmation. If not, you will confirm the email and create a password.',
        ...
        attachEmail: {
            ...
            text: 'Email confirmed. Create a password to finish setting up your account.',
            savePassword: 'Save password',
            completed: 'Email has been added. You can now sign in with email and password.',
            missingToken: 'The email confirmation token is missing from this link.',
        },
        subscription: {
            title: 'Subscription',
